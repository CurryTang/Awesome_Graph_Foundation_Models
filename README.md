...
* (**Arxiv '24**) Fractal Patterns May Unravel the Intelligence in Next-Token Prediction [[Paper](https://arxiv.org/pdf/2402.01825.pdf]
...
* (**NIPS '22**) Tree Mover’s Distance: Bridging Graph Metrics and Stability of Graph Neural Networks [[Paper](https://arxiv.org/pdf/2210.01906.pdf)]
* (**NIPS '21**) Rethinking Graph Transformers with Spectral Attention [[Paper](https://arxiv.org/abs/2106.03893)]
